                                                                        ...
                                                                        <label class="center-block image-upload"
                                                                            ...
                                                                            <figure>
                                                                                <img src="{{ !empty($banner_images[$i]) ? url($banner_images[$i]) : url('/assets-2/img/banner/625x490.jpg') }}"
                                                                                    ...
                                                                                    style="width:625px; height:490px; object-fit:cover;">
                                                                            </figure>
                                                                            <input type="hidden"
                                                    ...
                                                    <div class="col-md-12 pb-3">
                                                        <h4 id="banner_image_{{ $i }}">
                                                            <label for="banner_image_{{ $i }}"
                                                                class="required-star">Banner Image</label>
                                                        </h4>
        ...
        let html = `
            <div class="banner-group border p-3 mb-3">
                ...
                <div class="form-group mb-2 row has-feedback">
                    <div class="row">
                        <div class="col-md-12 addImages">
                            <label class="center-block image-upload" for="banner_image_${index}">
                                <figure>
                                    <img src="/assets-2/img/banner/625x490.jpg"
                                        class="img-responsive img-thumbnail"
                                        id="banner_image_preview_${index}" style="width:625px; height:490px; object-fit:cover;">
                                </figure>
                                <input type="hidden" id="banner_image_base64_${index}" name="banner_image_base64[]" value="">
                            </label>
                        </div>
                        <div class="col-md-12 pb-3">
                            <h4><label for="banner_image_${index}" class="required-star">Banner Image</label></h4>
                            <p class="text-success fw-bold small">[File Format: *.jpg/ .jpeg/ .png | Width 625PX, Height 490PX]</p>
                            <span id="banner_image_err_${index}" class="text-danger" style="font-size: 10px;"></span>
                            <input type="file" class="form-control" name="banner_image_file[]"
                                id="banner_image_${index}"
                                onchange="imageUploadWithCropping(this, 'banner_image_preview_${index}', 'banner_image_base64_${index}')"
                                size="625x490">
                        </div>
                    </div>
                </div>
