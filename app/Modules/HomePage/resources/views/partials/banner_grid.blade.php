                                ...
                                <div class="banner-grid-group border p-3 mb-3">
                                    ...
                                    <div class="form-group mb-2 row">
                                        <div class="col-md-12 addImages">
                                            <label class="center-block image-upload" for="banner_grid_image_{{ $i }}">
                                                <figure>
                                                ...
                                                <input type="hidden" id="banner_grid_image_base64_{{ $i }}" name="banner_grid_image_base64[]" value="">
                                                @if (!empty($banner_grid_images[$i]))
                                                    <input type="hidden" name="banner_grid_image[]" value="{{ $banner_grid_images[$i] }}" />
                                                @endif
                                            </label>
                                        </div>
                                        <div class="col-md-12 pb-3">
                                            <h4>
                                                <label for="banner_grid_image_{{ $i }}" class="required-star">Banner Grid Image</label>
                                            </h4>
                                            <p class="text-success fw-bold small">[File Format: *.jpg/ .jpeg/ .png | Width 555PX, Height 180PX]</p>
                                            <span id="banner_grid_image_err_{{ $i }}" class="text-danger" style="font-size: 10px;"></span>
                                            <input type="file" class="form-control" name="banner_grid_image_file[]" id="banner_grid_image_{{ $i }}"
            ...
            <div class="form-group mb-2 row">
                ...
                <div class="col-md-12 pb-3">
                    ...
                    <input type="file" class="form-control" name="banner_grid_image_file[]"
                        ...
                        onchange="imageUploadWithCropping(this, 'banner_grid_image_preview_${index}', 'banner_grid_image_base64_${index}')"
                        size="555x180">
                </div>
            </div>
