                                        ...
                                        <div id="browseimagepp_banner_grid_image">
                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 addImages">
                                                                    <label class="center-block image-upload"
                                                                        ...
                                                                        <input type="hidden"
                                                                            ...
                                                                            name="banner_grid_image_base64[]"
                                                                            value="">
                                                                        @if (!empty($banner_grid_images[$i]))
                                                                            <input type="hidden"
                                                                                name="banner_grid_image[]"
                                                ...
                                                <div class="col-md-12 pb-3">
                                                    ...
                                                    <span id="banner_grid_image_err_{{ $i }}"
                ...
                <div class="input-group mb-2 row has-feedback">
                        <div id="browseimagepp_banner_grid_image">
                            <div class="row">
                                                ...
                                                <div class="col-md-12 addImages">
                                                    <label class="center-block image-upload" for="banner_grid_image_{{ $i }}">
                                                        <figure>
                                                            <img src="{{ !empty($banner_grid_images[$i]) ? url($banner_grid_images[$i]) : url('/assets-2/img/banner-grid/555x180.jpg') }}"
                                                                class="img-responsive img-thumbnail"
                                                                id="banner_grid_image_preview_{{ $i }}" width="555px"
                                                                height="180px">
                                                        </figure>
                                                        <input type="hidden" id="banner_grid_image_base64_{{ $i }}"
                                ...
                                <div class="col-md-12 pb-3">
                                    <h4 id="banner_grid_image_{{ $i }}">
                                        <label for="banner_grid_image_{{ $i }}" class="required-star">Menu Slider Item Image</label>
                                    </h4>
